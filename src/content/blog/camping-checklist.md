---
title: "캠핑 준비물 체크리스트 (오토캠핑·어린이 동반·낚시)"
description: "오토캠핑 3~4인 어린이 동반 기준 캠핑 준비물 체크리스트. 항목을 클릭하면 실시간으로 진행률이 반영됩니다."
publishedAt: 2026-04-03
category: "camping"
tags: ["캠핑", "캠핑준비물", "오토캠핑", "캠핑체크리스트", "어린이캠핑"]
---
...
(function() {
  const sections = [
    ...
    { id:"sleep", icon:"🛏", title:"침구 / 수면", items:[
      ...
      {label:"담요 / 이불 (어린이용 포함)",must:true},{label:"수면 양말",must:false},
    ]},
